...
#define U3_HASHTABLE_H
  ...
  **/
    ...
    **/
      ...
      */
#     define  u3h_slot_is_null(sot)  ((0 == ((sot) >> 30)) ? c3y : c3n) /* ;;: -- Are these issues? */
...
#     define  u3h_slot_to_node(sot)  (u3a_into(((sot) & 0x3fffffff) << 1))
#     define  u3h_node_to_slot(ptr)  ((u3a_outa((ptr)) >> 1) | 0x40000000)
